...
const MENU_DATA = [
  {
    ...
    items: [
      ...
      { name: "Double Espresso", price: 55, description: "Double shot of pulled espresso", image: "images/menu/double-espresso.png" },
      ...
      { name: "Spanish Latte", price: 80, description: "Espresso · milk · condensed milk", image: "images/menu/spanish-latte.png" },
      { name: "Macchiato", price: 40, description: "Espresso · a dash of milk foam", image: "images/menu/macchiato.png" },
      { name: "Nutella Coffee", price: 75, description: "Espresso · Nutella · whipped cream · cone biscuit", image: "images/menu/nutella-coffee.png" },
      ...
      { name: "Turkish Coffee Double", price: 45, description: "Double measure of Turkish coffee", image: "images/menu/turkish-coffee-double.png" },
      {
      ...
      { name: "Nescafé", price: 65, description: "Instant coffee · hot water", image: "images/menu/nescafe.png" },
      {
        ...
        image: "images/menu/tyt-caffe.png",
  ...
  },
  {
    ...
    icon: "iced",
    items: [
      { name: "Iced Latte", price: 75, description: "Espresso · cold milk · ice", image: "images/menu/iced-latte.png" },
      ...
      { name: "Matcha Latte", price: 90, description: "Matcha · milk · ice", image: "images/menu/matcha-latte.png" },
      ...
      { name: "Boba Iced Coffee", price: 95, description: "Boba · iced coffee milk · espresso", image: "images/menu/boba-iced-coffee.png" }
    ]
  },
  {
    id: "specialty-coffee",
    ...
    items: [
      { name: "V60", price: 120, description: "Hot or cold", image: "images/menu/v60.png" },
      { name: "Syphon", price: 120, description: "Hot or cold", image: "images/menu/syphon.png" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Herbal Cocktail", price: 45, description: "Anise · fresh mint · lemon · honey", image: "images/menu/herbal-cocktail.png" },
      { name: "Apple Cider", price: 45, description: "Apple juice · cinnamon sticks", image: "images/menu/apple-cider.png" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Lemon or Lemon Mint", price: 55, description: "Fresh mint · lime · mint flavor", image: "images/menu/lemon-mint.png" },
      { name: "Alaska Cocktail", price: 75, description: "Pineapple · peach · fresh mint · pineapple slice", image: "images/menu/alaska-cocktail.png" },
      ...
      { name: "Dates with Milk", price: 95, description: "Dates · milk", image: "images/menu/dates-with-milk.png", note: "Added from the café's POS system — not on the original printed menu photo." },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "TYT Smoothie", price: 85, description: "Mango · passion fruit · peach", image: "images/menu/tyt-smoothie.png" },
      { name: "Smoothie Mixed Berry", price: 85, description: "Mixed berries", image: "images/menu/smoothie-mixed-berry.png" },
  ...
  },
  {
    ...
    icon: "shake",
    items: [
      { name: "Vanilla Shake", price: 85, description: "Ice cream · milk · whipped cream", image: "images/menu/vanilla-shake.png" },
      { name: "Blueberry Vanilla Shake", price: 90, description: "Ice cream · blueberry · milk · whipped cream", image: "images/menu/blueberry-vanilla-shake.png" },
      ...
      { name: "Mango Shake", price: 85, description: "Ice cream · mango · whipped cream", image: "images/menu/mango-shake.png" },
      { name: "Oreo Shake", price: 90, description: "Ice cream · Oreo · whipped cream", image: "images/menu/oreo-shake.png" }
    ]
  },
  {
    id: "coffee-frappe",
    ...
    items: [
      ...
      { name: "Lotus Frappé", price: 95, description: "Lotus sauce · milk · lotus biscuit · whipped cream", image: "images/menu/lotus-frappe.png" },
      { name: "Cookies Frappé", price: 105, description: "Cookies flavor · milk · chocolate powder · whipped cream", image: "images/menu/cookies-frappe.png" },
      {
        name: "TYT Frappé",
        price: 105,
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Mango Frappé", price: 95, description: "Mango · milk", image: "images/menu/mango-frappe.png" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Red Bull", price: 90, image: "images/menu/red-bull.png" },
      { name: "Mojito Soda", price: 95, description: "Lime soda · mint flavor · mojito flavor · fresh mint · lime", image: "images/menu/mojito-soda.png" },
      { name: "Red Bull Coffee", price: 85, description: "Single shot espresso", image: "images/menu/red-bull-coffee.png" },
      { name: "Red Bull Mix Berry", price: 95, description: "Mixed berries", image: "images/menu/red-bull-mix-berry.png" },
      {
        name: "Scotch Mint",
        price: 65,
        image: "images/menu/scotch-mint.png",
      ...
      { name: "Boba Soda", price: 90, description: "Lime soda · boba · fresh mint · lime", image: "images/menu/boba-soda.png" }
    ]
  },
  {
    ...
    items: [
      { name: "Pepsi Can", price: 30, image: "images/menu/pepsi-can.png" },
      { name: "7Up Can", price: 30, image: "images/menu/7up-can.png" },
      { name: "Mirinda Can", price: 25, image: "images/menu/mirinda-can.png" },
      { name: "Pepsi Mojito Can", price: 25, note: "POS label read as \"Pepsi Mojito\" — an unusual flavor combination, worth confirming." },
      { name: "Mountain Dew Can", price: 30, image: "images/menu/mountain-dew-can.png" },
      { name: "Fayrouz Pineapple", price: 30, image: "images/menu/fayrouz-pineapple.png" },
      { name: "Birell Can", price: 30, note: "POS label was hard to read clearly on video; \"Birell\" (non-alcoholic malt drink) is the best guess. Please confirm.", image: "images/menu/birell-can.png" },
      { name: "V7 Pink Lemonade", price: 25, image: "images/menu/v7-pink-lemonade.png" },
      ...
      { name: "V7 Cola", price: 30, image: "images/menu/v7-cola.png" },
      { name: "Nescafé Can", price: 40, note: "POS showed four separate Nescafé-can buttons, all at 40 EGP — likely different flavors (e.g. original, latte, mocha, caramel) but the flavor labels weren't legible on video. Shown here as one line; please confirm the actual flavor names.", image: "images/menu/nescafe-can.png" },
      { name: "Rani Juice", price: 30, image: "images/menu/rani-juice.png" }
    ]
  },
  {
    id: "croissant",
  ...
  },
  {
    ...
    items: [
      { name: "Light Roast", price: 250, image: "images/menu/tyt-light-roast.png" },
      {
        name: "Medium Roast",
        price: 280,
        image: "images/menu/tyt-medium-roast.png",
  ...
  },
  {
    ...
    note: "New category added from the café's POS system — not on the original printed menu photo.",
    items: [
      { name: "Molten Cake", price: 90, image: "images/menu/molten-cake.png" },
      { name: "Cheesecake", price: 80, image: "images/menu/cheesecake.png" },
      { name: "Chocolate Fudge", price: 65, image: "images/menu/chocolate-fudge.png" },
